                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="start_date" value="<?= $product->start_date;?>" class="form-control" placeholder="00.00"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="end_date" class="form-control" value="<?= $product->end_date;?>" placeholder="00"/>
                                        </div>
                                        <div class="form-group">
